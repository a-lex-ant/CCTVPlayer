...
public class ClientTCPGUI extends javax.swing.JFrame
    {
    ...
    public ClientTCPGUI ( Locale l)
        {

        this.l = l;
        rboundle = ResourceBundle.getBundle("LanguageBundles/LanguageBundle" , l);
        initComponents();
    ...
    private void avviaActionPerformed ( ActionEvent evt )
        ...
        int risp = JOptionPane.showConfirmDialog(null , pannelloInput = new PannelloRichiestaDatiPerTCP() ,
        ...
        if ( risp == JOptionPane.OK_OPTION )
            ...
            try
                ...
                client = new ClientTCP(indirizzo , port);
