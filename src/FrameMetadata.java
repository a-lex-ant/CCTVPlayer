...
public class FrameMetadata extends JFrame
    ...
    public FrameMetadata ()
        ...
        panel.setBorder(new TitledBorder(null , Principale.bundle_lingua.getString("STAT_SULLA_CONNESSIONE") ,
                TitledBorder.LEADING , TitledBorder.TOP , null , null));
        rootPanel.add(panel , BorderLayout.CENTER);
        panel.add(new NetworkMonitorPanel());

        JPanel panel_1 = new JPanel();
        panel_1.setBorder(new TitledBorder(null , Principale.bundle_lingua.getString("INFORMAZIONI_SUL_MEDIA") ,
                TitledBorder.LEADING , TitledBorder.TOP , null , null));
